...
description_en: "Desktop app to convert Salesforce profiles to Permission Sets. Visual interface with drag & drop, three conversion modes and integrated CLI."
...
outcomes_en:
  - "Automatic conversion of .profile-meta.xml to .permissionset-meta.xml, 100% Salesforce DX compatible"
  - "Three generation modes: Single, Split and Unified for different migration patterns"
  - "Cross-platform desktop interface with drag & drop, real-time progress and XML preview"
techStack: ["Electron", "React 18", "Tailwind CSS", "Node.js", "fast-xml-parser", "Commander"]
featured: true
order: 3
caseStudyAvailable: true
liveUrl: "https://permsetbuilder.vercel.app/"
previewVideo: "/Permsetvideo.mp4"
---
